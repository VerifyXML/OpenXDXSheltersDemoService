...
/**
 * Sample JSON RESTful Web Service for Shelters Search Demo.
 * 
 * @author Serge Leontiev <sergeleo@users.sourceforge.net>
 */
@Path("/JSON")
public class SheltersJSONResource {
    private static final Logger LOG = Logger.getLogger(SheltersJSONResource.class.getName());    
    ...
    public Response getJSON(@QueryParam("zip") String zip) {
        ...
        try{
            String xml = openXDXHandler.getOpenXDX(zip);
            if(xml != null){
    ...
    private String convertXMLtoJSON(String xml) throws IOException{
        ...
        try {
            ...
            Logger.getLogger(SheltersJSONResource.class.getName()).log(Level.SEVERE, null, ex);

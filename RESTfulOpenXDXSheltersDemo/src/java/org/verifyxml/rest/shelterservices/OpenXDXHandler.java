 ...
 */
package org.verifyxml.rest.shelterservices;
...
public class OpenXDXHandler {
    ...
    private static String SHELTERS_DATASOURCE_CONTEXT = "jdbc/Shelters";

    // OpenXDX variables
    private static final String OPEN_XDX_DUMP_XML = "-open-xdx-dump.xml";

    //CAM Templates
    private static final String PROVIDER_LOOKUP_QUERY_TEMPLATE = "/SheltersLookup.cxf";
    private File providerTemplateFile;
    
    // Data source
    private DataSource datasourceShelters;
    ...
    public OpenXDXHandler() {        
        ...
        try {
            ...
            datasourceShelters = (DataSource)initialContext.lookup(SHELTERS_DATASOURCE_CONTEXT);
     ...
     */
    public String getOpenXDX(String zip) {
        ...
        try {
            ...
            // Set Data source
            processor.setDataSource(datasourceShelters);
